...
La gestion des onglets et fenêtres consiste à pouvoir librement naviguer entre les onglets et fenêtres ouvertes par le navigateur.

# Scénario de test

- The Internet : Ouvrir un nouvel onglet et revenir sur l'onglet précédent
- Alapanme github.io : Ouvrir une nouvelle fenêtre et revenir sur la fenêtre précédente
...
<ThumbDownAlert>
    La gestion des fenêtre ouvertes par un autre moyen n'est pas aussi simple, l'utilisateur Alapan proposait une solution sur [son site](https://testersdock.com/cypress-new-window/) mais elle est plutôt convoluée, et marquée comme dépréciée avec la version courante de Cypress.
    De plus la solution ne semblait fonctionner qu'avec des liens statiques.
</ThumbDownAlert>
