...
```
<ThumbInfoAlert>
    Il est nécessaire de préciser une url ou un domaine et un chemin à la création d'un cookie, mais il n'est pas nécessaire que ces valeurs correspondent à la page courante ([documentation](https://playwright.dev/docs/api/class-browsercontext)).
</ThumbInfoAlert>
